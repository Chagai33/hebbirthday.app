...
| `date-fns-tz` | `^3.2.0` | טיפול ב-Time Zones | המרת זמנים (UTC/IL) |
...
| Package | גרסה | למה צריך את זה | הערות |
|---------|------|----------------|-------|
| `react-facebook-pixel` | `^1.0.4` | Facebook Pixel | מעקב המרות ופרסום |
| `react-ga4` | `^2.1.0` | Google Analytics 4 | סטטיסטיקות שימוש |
...
| `uuid` | `^13.0.0` | יצירת מזהים ייחודיים | עבור רשומות חדשות |
...
| `date-fns-tz` | `^3.2.0` | טיפול ב-Time Zones | נדרש לתיקוני שעות בשרת |

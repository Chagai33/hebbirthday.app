    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 sm:p-4 z-50 overflow-y-auto">
      <div ref={modalFocusRef} className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[calc(100vh-2rem)] overflow-y-auto my-auto" role="dialog" aria-modal="true" aria-labelledby="share-group-modal-title">
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-x-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 p-3 sm:p-4 bg-gray-50 rounded-lg">
            <div className="flex-1 min-w-0">
                ...
                <>
                  ...
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <div className="flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-gray-50 border border-gray-300 rounded-lg text-xs sm:text-sm text-gray-700 break-all overflow-wrap-anywhere" style={{ wordBreak: 'break-all', overflowWrap: 'anywhere' }}>
                        {guestLink}
                      </div>
                      <button
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div className="text-xs sm:text-sm text-blue-800 space-y-1 min-w-0">
                      <p className="font-semibold">
                        {t('groups.guestLinkLimitations', 'מגבלות קישור')}
                      </p>
                      <ul className="list-disc list-inside space-y-1 text-blue-700">
                        <li className="break-words">{t('groups.linkExpires72Hours', 'הקישור תקף ל-72 שעות בלבד')}</li>
                        <li className="break-words">{t('groups.maxContributions', 'מקסימום 50 הוספות לכל קישור')}</li>
                        <li className="break-words">{t('groups.resetLinkForNew', 'ניתן לאפס ולהפיק קישור חדש בכל עת')}</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="px-3 sm:px-4 py-2 sm:py-3 bg-green-50 border border-green-300 rounded-lg text-xs sm:text-sm text-gray-700 whitespace-pre-wrap break-words overflow-wrap-anywhere" dir="auto" style={{ wordBreak: 'break-word', overflowWrap: 'anywhere' }}>
                        {whatsAppMessage}
                      </div>
                      <div className="flex flex-col sm:flex-row gap-2">
                        <button
                          onClick={handleCopyWhatsApp}
                          className={`flex-1 px-3 sm:px-4 py-2 rounded-lg transition-colors font-semibold flex items-center justify-center gap-2 text-sm ${
                            copiedWhatsApp

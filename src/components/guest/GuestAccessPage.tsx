...
export const GuestAccessPage: React.FC = () => {
  ...
  // currentLangLabel removed - handled by LanguageSwitcher
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div>
                  ...
                  <div className="flex gap-2 p-1 bg-gray-100 rounded-lg mb-2">
                    <button
                      type="button"
                      className={`flex-1 py-1.5 text-xs sm:text-sm font-medium rounded-md transition-all ${dateInputType === 'gregorian' ? 'bg-white shadow text-blue-600' : 'text-gray-500 hover:text-gray-700'
                        }`}
                    ...
                    <button
                      type="button"
                      className={`flex-1 py-1.5 text-xs sm:text-sm font-medium rounded-md transition-all ${dateInputType === 'hebrew' ? 'bg-white shadow text-purple-600' : 'text-gray-500 hover:text-gray-700'
                        }`}
                ...
                {filteredBirthdays.map(birthday => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${birthday.gender === 'male' ? 'bg-blue-100' : 'bg-pink-100'
                          }`}
                      >

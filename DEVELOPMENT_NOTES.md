...
- בין 20/12 00:01 ל-20/12 16:46 - הרשומה בדאשבורד עם "-1 ימים"
...
2. **20/12 00:01** - התאריך עבר, עכשיו -1 ימים, אבל הפונקציה לא רצה ❌
3. **20/12 16:46** - הפונקציה רצה סוף סוף ועדכנה (15+ שעות באיחור!)

**הפתרון:**
```typescript
// ✅ קוד מתוקן:
.schedule('1 0 * * *')  // כל לילה ב-00:01 שעון ישראל
.timeZone('Asia/Jerusalem')
```

**Flow תקין:**
1. **00:01** - `updateNextBirthdayScheduled` רץ אוטומטית
